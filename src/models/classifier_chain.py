...
class MultilabelClassifierChain:
    def __init__(self, train_data: pd.DataFrame = None, text_column: str = 'Perguntas', labels_column: str = 'all_tags', labels_names: list[str] = None):
        ...
        self.model = None
        self.model_file_path = './data/models/multilabel_classifier_chain.joblib'
    ...
    def __get_model__(self) -> ClassifierChain:
    ...
    def __train__(self) -> ClassifierChain:
